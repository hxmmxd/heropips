...
import {
  Zap, Crown, Rocket, Loader2, Play, Copy, Shield, Settings, Activity, Send, Trash2, Key, Terminal, FileText, Mail, Receipt, Cpu, Eye, EyeOff, CheckCircle2, Percent, Clock, RefreshCw, AlertTriangle, XCircle, GraduationCap
} from 'lucide-react';
...
export default function AdminSettings({
  ...
  const [settingsSubPage, setSettingsSubPage] = useState<'main' | 'referral' | 'pricing' | 'announcements' | 'payments' | 'smtp' | 'invoice' | 'integrations' | 'rebates' | 'cron' | 'courses' | 'apis'>('main');
...
// ──────────────────────────────────────────────────────────────────────
// 10. CRON JOBS TAB (Monitor + Manual Trigger)
// ──────────────────────────────────────────────────────────────────────
interface CronJob {
  id: string;
  name: string;
