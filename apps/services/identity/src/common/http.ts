...
/**
 * Client IP for rate limiting and audit rows. The forwarded header wins when
 * present and well-formed; otherwise the direct peer. Callers with neither get
 * `unknown`, which is a *shared* bucket — restrictive, never fail-open.
 */
...
export function requestMeta(req: HttpRequest): RequestMeta {
